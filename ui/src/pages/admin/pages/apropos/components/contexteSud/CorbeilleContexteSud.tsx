...
import CorbeilleZoneGenerale from "../../../../../../usecases/Generalec/CorbeilleGenerale";
...
interface CorbeilleContexteSudProps {
    handleRefetchList: any;
}

const CorbeilleContexteSud: React.FC<CorbeilleContexteSudProps> = ({ handleRefetchList }) => {
    ...
    useEffect(() => {
        const fetchActus = async () => {
            const data = await new CorbeilleZoneGenerale().execute({
                idcategorie: 2,
                idrubrique: 10,
            });
...
export default CorbeilleContexteSud;
