...
interface UpdateConsultantProps {
  consultant: any;
  onclose: any;
  refetch: () => void;
}

const UpdateConsultant: React.FC<UpdateConsultantProps> = ({
  consultant,
  onclose,
  refetch,
}) => {
  ...
  const initialValues = {
    titre: `${consultant.titre ? consultant.titre : ""}`,
    contenu: `${consultant.datelimite ? consultant.datelimite : ""}`,
  };
  ...
  const onSubmit = async (values: any, { resetForm }: any) => {
    ...
    values.idrubrique = 15;
    values.id = consultant.id;
  ...
  return (
    <div className="px-4">
      <div className="flex justify-center">
        <p className="">Modification de consultant</p>
      </div>
