...
interface UpdateStatiGestionPlainteProps {
  actualite: any;
  onClose: any;
...
const UpdateStatiGestionPlainte: React.FC<UpdateStatiGestionPlainteProps> = ({
  actualite,
  buttonActiver,
  onClose,
  refetch,
    ...
    <div className="px-4">
      <div className="flex justify-center">
        <p className="text-yellow">
          Modification de la statistique de gestion des plaintes
        </p>
      </div>
      <Formik
...
export default UpdateStatiGestionPlainte;
