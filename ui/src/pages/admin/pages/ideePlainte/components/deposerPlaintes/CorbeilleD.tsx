...
import CorbeilleDGenerale from "../../../../../../usecases/Generalec/CorbeilleGenerale";
...
const CorbeilleD: React.FC<CorbeilleProps> = ({ handleRefetchList }) => {
    ...
    useEffect(() => {
        const fetchActus = async () => {
            const data = await new CorbeilleDGenerale().execute({
                idcategorie: 1,
                idrubrique: 1,
            });
