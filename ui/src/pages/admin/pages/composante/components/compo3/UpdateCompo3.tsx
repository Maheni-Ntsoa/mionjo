...
const UpdateCompo3: React.FC<UpdateCompo3Props> = ({
  objectif,
  buttonActiver,
  onClose,
  refetch,
  ...
  return (
    <div className="px-4">
      <div className="flex justify-center">
        <p className="text-yellow">Modification de le composante 3</p>
      </div>
      <Formik
