...
const UpdateCompo4: React.FC<UpdateCompo4Props> = ({
  objectif,
  buttonActiver,
  onClose,
  refetch,
  ...
  return (
    <div className="px-4">
      <div className="flex justify-center">
        <p className="text-yellow">Modification de le composante 4</p>
      </div>
      <Formik
