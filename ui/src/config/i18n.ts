  ...
  resources: {
    en: {
      translation: {
        ...
        encour: "in progress",
        edito1:
          `"Welcome to the Mionjo Project website, a governmental initiative dedicated to strengthening the resilience of Southern Madagascar. We are delighted to welcome you to our online community, and we are committed to sharing with you our commitment to a more resilient and prosperous South.
        ...
        edito2:
          `"At the heart of our approach lies investment in resilient infrastructure and resilient livelihoods, thus supporting an integrated and multi-sectoral approach. We firmly believe that coordination among various stakeholders is essential to achieving our goals.
    ...
    fr: {
      translation: {
        ...
        soustitrecompo1: "La composante 1 du projet est axé sur le renforcement de la gouvernance locale décentralisée, la planification participative et la résilience sociale. Elle vise à améliorer la gouvernance locale participative, renforcer la résilience sociale et prévenir les conflits, en créant un environnement propice au développement durable dans les régions méridionales de Madagascar.",
        titreSousCompo1A: "Sous-composante 1A",
        titreSousCompo1B: "Sous-composante 1B",
        titreSousCompo1C: "",
        titreSousCompo1D: "",

        textSousCompo1A: "Réhabilitation des collectivités territoriales décentralisées pour améliorer la planification communautaire et la prestation de services essentiels, avec un accent sur la mise en place de Structures Locales de Concertation (SLC).",
        textSousCompo1B: "Renforcement de la résilience sociale en améliorant la résilience sociale face aux changements climatiques, à la sécheresse et à d'autres risques sociaux en soutenant la cohésion sociale, en particulier parmi les jeunes et les femmes, pour la prévention et la résolution des conflits locaux.",
        textSousCompo1C: "",
        textSousCompo1D: "",

        titrecompo2: "Composante 2",
        soustitrecompo2: "La composante 2 du projet Mionjo permet de développer des infrastructures résilientes pour améliorer l'accès aux services de base, notamment l'eau potable et les routes, afin de renforcer la capacité des communautés locales à faire face aux chocs climatiques et à favoriser le développement économique.",
        titreSousCompo2A: "Sous-composante 2A",
        titreSousCompo2B: "Sous-composante 2B",
        titreSousCompo2C: "Sous-composante 2C",
        titreSousCompo2D: "",

        textSousCompo2A: "Subventions communautaires résilientes pour améliorer l'accès aux infrastructures de base dans les communes rurales en offrant des subventions pour des projets communautaires et intercommunaux, gérés et suivis par les communautés locales.",
        textSousCompo2B: "Infrastructures de résilience régionale en eau à travers la réhabilitation des infrastructures d'eau régionales, notamment les pipelines, pour garantir un approvisionnement en eau fiable aux communautés locales.",
        textSousCompo2C: "Amélioration de l'accès à des sources d'eau protégées et durables par la modernisation de points d'eau, leur regroupement en mini-réseaux polyvalents avec des batteries de stockage d'énergie solaire pour fournir un accès durable à l'eau répondant aux besoins multiples des communautés concernées.",
        textSousCompo2D: "",

        titrecompo3: "Composante 3",
        soustitrecompo3: "La composante 3 concerne l’accroissement de la résilience des moyens de subsistance des populations locales en renforçant les capacités de production alimentaire, en favorisant des chaînes de valeur durables et en promouvant l'adaptation aux changements climatiques.",
        ...
        textSousCompo3A: "Soutien aux organisations communautaires et aux chaînes de valeur locales à travers l’accompagnement des habitants des communes ciblées dans le renforcement de leurs moyens de subsistance, en fonction de leur vulnérabilité, en favorisant la durabilité et la résilience.",
        textSousCompo3B: "Système d'irrigation pour la résilience des moyens de subsistance à travers la réhabilitation des périmètres d'irrigation pour soutenir la productivité agricole dans les régions touchées par la sécheresse.",
        textSousCompo3C: "Restauration de la capacité de production alimentaire et renforcement des systèmes alimentaires et de moyens de subsistance en fournissant des ressources, des formations et des technologies pour améliorer la résilience face au changement climatique.",
        textSousCompo3D: "Développement des infrastructures vertes et des paysages résilients par la création de pépinières pour produire une végétation adaptative, la plantation d'arbres et d'arbustes brise-vents, le reboisement à des fins multifonctionnelle.",

        titrecompo4: "Composante 4",
        soustitrecompo4: "La composante 4 permet de faciliter la mise en œuvre réussie du projet en renforçant les capacités des acteurs impliqués, en fournissant des connaissances géospatiales pour le suivi et l'évaluation, et en soutenant la planification d'infrastructures essentielles.",
        ...
        textSousCompo4A: "Mise en œuvre du financement du projet, y compris les études, la gestion, l'administration, et l'apprentissage Étude des analyses préparatoires de la série de projets (SdP).",
        textSousCompo4B: "Étude des analyses préparatoires de la série de projets (SdP).",
        textSousCompo4C: "Renforcement de capacité du gouvernement à apporter une riposte au changement climatique, y compris la gestion des situations d'urgence, la résilience climatique au niveau local et le leadership dans la réponse au climat.",
        textSousCompo4D: "Développement des infrastructures vertes et des paysages résilients par la création de pépinières pour produire une végétation adaptative, la plantation d'arbres et d'arbustes brise-vents, le reboisement à des fins multifonctionnelle.",


        titrecompo5: "Composante 5",
        soustitrecompo5: "La composante 5 du projet vise à fournir une réponse d'urgence en cas de crises ou de situations d'urgence admissibles, avec une réaffectation de fonds depuis les autres composantes du projet. Cette composante a été activée en réponse à des périodes de sécheresse prolongées et à d'autres urgences touchant les populations.",
        ...
        textSousCompo5C: "Renforcement de capacité du gouvernement à apporter une riposte au changement climatique, y compris la gestion des situations d'urgence, la résilience climatique au niveau local et le leadership dans la réponse au climat.",
        textSousCompo5D: "Développement des infrastructures vertes et des paysages résilients par la création de pépinières pour produire une végétation adaptative, la plantation d'arbres et d'arbustes brise-vents, le reboisement à des fins multifonctionnelle.",
