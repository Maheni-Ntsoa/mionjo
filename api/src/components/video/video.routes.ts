...
router.route('/findByIdGenerale/:idgenerale').get(videoController.findByIdGenerale);
router.route('/:id').get(videoController.findOne);
router.route('/:id').delete(videoController.delete);
router.route('/createMany').post(upload.array('fichiers'), videoController.createMany);
