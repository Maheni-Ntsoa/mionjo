...
export const sendMailRetourPlainte = async (to: string) => {
    try {
        ...
        let transporter = nodemailer.createTransport({
            ...
            auth: {
                user: "hathawayroot@gmail.com", // generated ethereal user
                pass: "xmzbhtrucazhilzv", // generated ethereal password
            },
        });
        if (to) {
...
export const sendMailDepotPlainte = async (nom: string, prenom: string, tel: string, email: string, plainte: string) => {
    try {
        // host mailer
        let transporter = nodemailer.createTransport({
            service: "gmail",
        ...
        let info = await transporter.sendMail({
            to: "hathawayroot@gmail.com", // list of receivers
...
export const sendMailNousContacter = async (nom: string, prenom: string, email: string, objet: string, message: string) => {
    try {
        // host mailer
        let transporter = nodemailer.createTransport({
            service: "gmail",
        ...
        let info = await transporter.sendMail({
            to: "mionjo@mionjo.mg", // list of receivers
